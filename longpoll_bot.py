    ...
    def run_long_poll(self):
        ...
        for event in self.long_poll.listen():
            ...
            if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
                ...
                if event.text == "че делаешь?" or event.text == "че делаешь" or event.text == "Че делаешь?" or  event.text == "Че делаешь":
                    if event.from_user:
                        self.send_message(receiver_user_id=event.user_id, 
                            message_text="(J.A.R.V.I.S.) Расписание госпадина Герасимова на сегодня:\n    Работа:\n        c 7:30\n        до 16:30 \n    Тренировка:\n        с 18:00\n        до 20:30") 
